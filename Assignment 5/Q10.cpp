...
Student(n, addr, a, studId, gr, g) {
    ...
    void performDuties() {
        attendClass(courseAssisting); 
        conductMeeting("TA Meeting"); 
        gradeAssignments(15);
        holdOfficeHours(2);
        submitAssignment("Research Paper");  
    }
...
int main() {
    ...
    6001, "Computer Science", 25000,    
    3001, "Graduate", 3.9,               
    "Introduction to Programming", 20, 15000);  
    ta1.displayTAInfo();
    ta1.performDuties();
